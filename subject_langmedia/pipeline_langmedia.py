...
from config import LANGMEDIA_IMAGE_DIR, LANGMEDIA_JSON_DIR
os.makedirs(LANGMEDIA_JSON_DIR, exist_ok=True)
...
# 파일 이름 정렬
input_dir = str(LANGMEDIA_JSON_DIR)
...
def show_problem_image_set(similar_problems, image_base=str(LANGMEDIA_IMAGE_DIR)):
...
def pipeline_langmedia(context_image_path, question_image_path, top_k=10, image_base_dir=None):
